...
case_info = 'DOH COVID Data Drop_ 20200725 - 04 Case Information.csv'
...
if __name__ == '__main__':
    ...
    all_cases.to_excel('DOH COVID-19 Cases Per Region - 20200725.xlsx')
    ...
    # print(df_case_info.loc[(df_case_info['RemovalType'] == 'RECOVERED') & (~ df_case_info['DateDied'].isna())])
    # print(df_case_info.loc[(df_case_info['RemovalType'] == 'ACTIVE') & (~ df_case_info['DateDied'].isna())])
